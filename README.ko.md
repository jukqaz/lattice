...
Unix/Linux에서는 사람 사용자의 지속 설치와 automation 전용 설치를 분리합니다.

- **사용자 설치:** stable tag binary를 사용자 Cargo bin directory에 설치합니다. 사용자
  shell `PATH`에 `~/.cargo/bin`이 있어야 합니다. rustup default toolchain이 아직
